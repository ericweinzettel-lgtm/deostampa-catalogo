        ...
        <div className="grid grid-cols-2 md:grid-cols-3 col-span-1 md:col-span-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-light">
              <li><button onClick={() => setCurrentPage(Page.HOME)} className="hover:text-[#C5B08B] transition-colors text-left">Home</button></li>
              <li><button onClick={() => setCurrentPage(Page.PRODUCTS)} className="hover:text-[#C5B08B] transition-colors text-left">Prodotti</button></li>
              <li><button onClick={() => setCurrentPage(Page.ABOUT)} className="hover:text-[#C5B08B] transition-colors text-left">Chi Siamo</button></li>
              <li><button onClick={() => setCurrentPage(Page.CONTACT)} className="hover:text-[#C5B08B] transition-colors text-left">Contatti</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-light opacity-80">
              <li className="flex items-center space-x-3 group">
                ...
                <span className="group-hover:text-stone-800 transition-colors text-xs md:text-sm">+39 342 7796083</span>
              </li>
              <li className="flex items-center space-x-3 group text-xs md:text-sm">
                <span className="text-[#C5B08B]">✉️</span>
                <span className="group-hover:text-stone-800 transition-colors break-all">info@deostampa.it</span>
              </li>
            </ul>
          </div>
